...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, ReactiveFormsModule, SongCardComponent, PlaylistCardComponent],
  template: `
        ...
        @if (isLoading) {
          ...
          <div class="playlists-grid">
            @for (playlist of playlists; track playlist._id) {
              <app-playlist-card [playlist]="playlist" (deleted)="onPlaylistDeleted($event)" />
            }
          </div>
        }
      }
