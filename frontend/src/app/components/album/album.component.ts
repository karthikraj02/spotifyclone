  ...
  styles: [`
    ...
    .album-header {
      ...
      .album-info {
        ...
        .meta {
          display: flex; align-items: center; gap: 0.5rem; color: #B3B3B3; font-size: 0.875rem;
          .artist-link { color: #fff; font-weight: 700; text-decoration: none; &:hover { text-decoration: underline; } }
        }
      }
    }
    ...
    .empty-album { padding: 2rem; color: #B3B3B3; }
  `]
})
export class AlbumComponent implements OnInit {
  album: AlbumDetail | null = null;
  isLoading = true;
  headerGradient = 'linear-gradient(to bottom, #4a2d5e, #121212)';
