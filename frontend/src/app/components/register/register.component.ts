...
@Component({
        ...
        <form [formGroup]="registerForm" (ngSubmit)="onSubmit()">
          ...
          <div class="form-group">
            ...
            @if (registerForm.get('username')?.invalid && registerForm.get('username')?.touched) {
              <span class="error-msg">Username must be 3-30 characters</span>
            }
          </div>
          ...
          <div class="form-group">
            ...
            <input id="confirmPassword" type="password" formControlName="confirmPassword" placeholder="Confirm password"
              [class.error]="registerForm.get('confirmPassword')?.touched && registerForm.hasError('passwordMismatch')" />
  ...
  styles: [`
    ...
    h1 { font-size: 2rem; font-weight: 700; color: var(--text-primary); margin-bottom: 2rem; }
